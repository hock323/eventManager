...
public class ExitDialog implements Initializable {
    ...
    public ExitDialog(Window owner, String str1, String str2, SimpleBooleanProperty answer, ResourceBundle bundle) {
        try {
            dialogStage = new Stage();
            URL location = getClass().getResource("/eventManager/fx/ExitDialog.fxml");
            FXMLLoader fxmlLoader = new FXMLLoader(location, bundle);
            fxmlLoader.setBuilderFactory(new JavaFXBuilderFactory());
            AnchorPane dialogPane = (AnchorPane) fxmlLoader.load();
            ExitDialog dialogController = fxmlLoader.getController();
